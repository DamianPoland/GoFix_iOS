//
//  ViewControllerCraftsmanRegisterToken.swift
//  GoFix
//
...
class ViewControllerCraftsmanRegisterToken: UIViewController, FetchDataDelegate{
    ...
    func didFetchDataSuccess(code: Int, data: Data) {
        ...
        if let result = try? JSON(data: data){ // must be import SwiftyJSON
            ...
            defaults.set(true, forKey: C.isCraftsman)
